...
public class GlobalOptionKeys {
    ...
    public static final String SFMAIN_INTEGRATION_EXECUTABLES_PYTHON = "sfmain.integration.executables.python";
    ...
    public static final String SFMAIN_LOG_DIRECTORY = "sfmain.logdir";
    public static final String SCM_PYTHON_PATH = "scm.python.path";
